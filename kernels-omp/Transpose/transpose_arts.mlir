module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:o-i64:64-i128:128-n32:64-S128", llvm.target_triple = "arm64-apple-macosx15.0.0", "polygeist.target-cpu" = "apple-m1", "polygeist.target-features" = "+aes,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.if %12 {
      ...
      %47 = memref.load %arg1[%c0] : memref<?xmemref<?xi8>>
    ...
    %25:2 = scf.if %24 -> (i32, i1) {
      %45 = memref.load %arg1[%c4] : memref<?xmemref<?xi8>>
    ...
    arts.edt <parallel> <internode> route(%c0_i32) {
      ...
      scf.if %26 {
        ...
        arts.for(%c0) to(%52) step(%53) {{
        ^bb0(%arg2: index):
          %54 = arith.index_cast %arg2 : index to i64
          %55 = arith.addi %54, %47 : i64
          %56 = arith.cmpi slt, %22, %55 : i64
          %57 = arith.select %56, %22, %55 : i64
          %58 = arith.index_cast %21 : i32 to index
          %59 = arith.index_cast %29 : i32 to index
          scf.for %arg3 = %c0 to %58 step %59 {
            %60 = arith.divui %arg3, %59 : index
            %61 = arith.muli %60, %59 : index
            %62 = arith.index_cast %61 : index to i64
            %63 = arith.addi %62, %47 : i64
            %64 = arith.cmpi slt, %22, %63 : i64
            %65 = arith.select %64, %22, %63 : i64
            %66 = arith.index_cast %57 : i64 to index
            scf.for %arg4 = %arg2 to %66 step %c1 {
              %67 = arith.index_cast %arg4 : index to i64
              %68 = arith.muli %22, %67 : i64
              %69 = arith.index_cast %65 : i64 to index
              scf.for %arg5 = %61 to %69 step %c1 {
                %70 = arith.index_cast %arg5 : index to i64
                %71 = arith.addi %70, %68 : i64
                %72 = arith.index_cast %71 : i64 to index
                %73 = arith.addi %68, %70 : i64
                %74 = arith.sitofp %73 : i64 to f64
                %75 = arith.index_cast %72 : index to i32
                %76 = llvm.getelementptr %33[%75] : (!llvm.ptr, i32) -> !llvm.ptr, f64
                llvm.store %74, %76 : f64, !llvm.ptr
                %77 = llvm.getelementptr %37[%75] : (!llvm.ptr, i32) -> !llvm.ptr, f64
                llvm.store %cst_2, %77 : f64, !llvm.ptr
              }
            }
          }
        }}
        ...
        arts.for(%c0) to(%47) step(%c1) {{
        ^bb0(%arg2: index):
          %48 = arith.index_cast %arg2 : index to i64
          %49 = arith.muli %22, %48 : i64
          %50 = arith.index_cast %21 : i32 to index
          scf.for %arg3 = %c0 to %50 step %c1 {
            %51 = arith.index_cast %arg3 : index to i64
            %52 = arith.addi %51, %49 : i64
            %53 = arith.index_cast %52 : i64 to index
            %54 = arith.addi %49, %51 : i64
            %55 = arith.sitofp %54 : i64 to f64
            %56 = arith.index_cast %53 : index to i32
            %57 = llvm.getelementptr %33[%56] : (!llvm.ptr, i32) -> !llvm.ptr, f64
            llvm.store %55, %57 : f64, !llvm.ptr
            %58 = llvm.getelementptr %37[%56] : (!llvm.ptr, i32) -> !llvm.ptr, f64
            llvm.store %cst_2, %58 : f64, !llvm.ptr
          }
        }}
      }
      %45 = arith.addi %18, %c1_i32 : i32
      %46 = arith.index_cast %45 : i32 to index
      scf.for %arg2 = %c0 to %46 step %c1 {
        scf.if %26 {
          %47 = arith.extsi %29 : i32 to i64
          %48 = arith.subi %c1_i64, %47 : i64
          %49 = arith.subi %22, %48 : i64
          ...
          ^bb0(%arg3: index):
            ...
            %58 = arith.index_cast %21 : i32 to index
            %59 = arith.index_cast %29 : i32 to index
            scf.for %arg4 = %c0 to %58 step %59 {
              %60 = arith.divui %arg4, %59 : index
              %61 = arith.muli %60, %59 : index
              %62 = arith.index_cast %61 : index to i64
              %63 = arith.addi %62, %47 : i64
              %64 = arith.cmpi slt, %22, %63 : i64
              %65 = arith.select %64, %22, %63 : i64
              %66 = arith.index_cast %57 : i64 to index
              scf.for %arg5 = %arg3 to %66 step %c1 {
                %67 = arith.index_cast %arg5 : index to i64
                %68 = arith.muli %22, %67 : i64
                %69 = arith.index_cast %65 : i64 to index
                scf.for %arg6 = %61 to %69 step %c1 {
                  %70 = arith.index_cast %arg6 : index to i64
                  %71 = arith.addi %70, %68 : i64
                  %72 = arith.index_cast %71 : i64 to index
                  %73 = arith.muli %22, %70 : i64
                  %74 = arith.addi %67, %73 : i64
                  %75 = arith.index_cast %74 : i64 to index
                  %76 = arith.index_cast %75 : index to i32
                  %77 = llvm.getelementptr %33[%76] : (!llvm.ptr, i32) -> !llvm.ptr, f64
                  %78 = llvm.load %77 : !llvm.ptr -> f64
                  %79 = arith.index_cast %72 : index to i32
                  %80 = llvm.getelementptr %37[%79] : (!llvm.ptr, i32) -> !llvm.ptr, f64
                  %81 = llvm.load %80 : !llvm.ptr -> f64
                  %82 = arith.addf %81, %78 : f64
                  llvm.store %82, %80 : f64, !llvm.ptr
                  %83 = llvm.load %77 : !llvm.ptr -> f64
                  %84 = arith.addf %83, %cst_1 : f64
                  llvm.store %84, %77 : f64, !llvm.ptr
                }
              }
            }
          }}
          ...
          ^bb0(%arg3: index):
            ...
            %49 = arith.muli %22, %48 : i64
            %50 = arith.index_cast %21 : i32 to index
            scf.for %arg4 = %c0 to %50 step %c1 {
              %51 = arith.index_cast %arg4 : index to i64
              %52 = arith.addi %51, %49 : i64
              %53 = arith.index_cast %52 : i64 to index
              %54 = arith.muli %22, %51 : i64
              %55 = arith.addi %48, %54 : i64
              %56 = arith.index_cast %55 : i64 to index
              %57 = arith.index_cast %56 : index to i32
              %58 = llvm.getelementptr %33[%57] : (!llvm.ptr, i32) -> !llvm.ptr, f64
              %59 = llvm.load %58 : !llvm.ptr -> f64
              %60 = arith.index_cast %53 : index to i32
              %61 = llvm.getelementptr %37[%60] : (!llvm.ptr, i32) -> !llvm.ptr, f64
              %62 = llvm.load %61 : !llvm.ptr -> f64
              %63 = arith.addf %62, %59 : f64
              llvm.store %63, %61 : f64, !llvm.ptr
              %64 = llvm.load %58 : !llvm.ptr -> f64
              %65 = arith.addf %64, %cst_1 : f64
  ...
  func.func private @test_results(%arg0: i64, %arg1: memref<?xf64>, %arg2: i32) -> f64 attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    memref.store %cst_0, %alloca_1[%c0] : memref<1xf64>
    ...
    arts.edt <parallel> <internode> route(%c0_i32) {
      ...
      ^bb0(%arg3: index):
        ...
        scf.for %arg4 = %c0 to %5 step %c1 {
          ...
          %23 = scf.if %22 -> (f64) {
            %25 = memref.load %arg1[%14] : memref<?xf64>
            %26 = arith.subf %25, %20 : f64
            scf.yield %26 : f64
          } else {
            %25 = memref.load %arg1[%14] : memref<?xf64>
            %26 = arith.subf %25, %20 : f64
    ...
    arts.atomic_add(%cast, %8 : memref<?xf64>, f64)
    %9 = memref.load %alloca_1[%c0] : memref<1xf64>
    return %9 : f64
  }
