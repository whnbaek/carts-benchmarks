module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:o-i64:64-i128:128-n32:64-S128", llvm.target_triple = "arm64-apple-macosx15.0.0", "polygeist.target-cpu" = "apple-m1", "polygeist.target-features" = "+aes,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.if %10 {
      ...
      %38 = affine.load %arg1[0] : memref<?xmemref<?xi8>>
    ...
    %19 = affine.load %arg1[3] : memref<?xmemref<?xi8>>
    ...
    %22 = affine.load %arg1[4] : memref<?xmemref<?xi8>>
    ...
    omp.parallel   {
      %36 = affine.load %alloca_1[] : memref<i32>
      func.call @bail_out(%36) : (i32) -> ()
      %37 = func.call @omp_get_thread_num() : () -> i32
      ...
      scf.if %45 {
        %51 = llvm.mlir.addressof @str15 : !llvm.ptr
        %52 = llvm.getelementptr %51[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<54 x i8>
        %53 = llvm.call @printf(%52, %37) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
        affine.store %c1_i32, %alloca_1[] : memref<i32>
      }
      func.call @bail_out(%46) : (i32) -> ()
      %47 = arith.index_cast %20 : i32 to index
      %48 = arith.index_cast %20 : i32 to index
      scf.for %arg2 = %c0 to %48 step %c1 {
        %51 = arith.index_cast %arg2 : index to i32
        %52 = arith.andi %51, %c7_i32 : i32
        %53 = arith.subi %c3_i32, %52 : i32
        %54 = llvm.getelementptr %42[%51] : (!llvm.ptr, i32) -> !llvm.ptr, i32
        llvm.store %53, %54 : i32, !llvm.ptr
        %55 = arith.addi %arg2, %47 : index
        %56 = arith.index_cast %55 : index to i32
        %57 = llvm.getelementptr %42[%56] : (!llvm.ptr, i32) -> !llvm.ptr, i32
        llvm.store %51, %57 : i32, !llvm.ptr
      }
      scf.execute_region {
        cf.switch %27 : i32, [
          default: ^bb2,
      ...
      ^bb1:  // pred: ^bb0
        ...
        %51 = func.call @fill_vec(%43, %20, %16, %c1_i32, %cast, %cast_3) : (memref<?xi32>, i32, i32, i32, memref<?xi32>, memref<?xi32>) -> i32
        cf.br ^bb2
      ^bb2:  // 2 preds: ^bb0, ^bb1
        scf.yield
      }
      ...
      ^bb1:  // pred: ^bb0
        %cast = memref.cast %alloca_0 : memref<1xi32> to memref<?xi32>
        %cast_3 = memref.cast %alloca : memref<1xi32> to memref<?xi32>
        %51 = func.call @fill_vec(%43, %20, %16, %c0_i32, %cast, %cast_3) : (memref<?xi32>, i32, i32, i32, memref<?xi32>, memref<?xi32>) -> i32
        cf.br ^bb2
      ^bb2:  // 2 preds: ^bb0, ^bb1
        scf.yield
      }
      affine.store %c0_i32, %alloca_2[] : memref<i32>
      %49 = arith.index_cast %20 : i32 to index
      %50 = scf.for %arg2 = %c0 to %49 step %c1 iter_args(%arg3 = %c0_i32) -> (i32) {
        %51 = arith.index_cast %arg2 : index to i32
        %52 = llvm.getelementptr %42[%51] : (!llvm.ptr, i32) -> !llvm.ptr, i32
        %53 = llvm.load %52 : !llvm.ptr -> i32
        %54 = arith.addi %arg3, %53 : i32
        affine.store %54, %alloca_2[] : memref<i32>
        scf.yield %54 : i32
      }
      omp.terminator
    }
    ...
    %34 = affine.load %alloca_2[] : memref<i32>
    ...
    scf.if %35 {
      ...
      %46 = arith.mulf %1, %cst : f64
      %47 = arith.divf %1, %46 : f64
