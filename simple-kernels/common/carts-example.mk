################################################################################
# Simple Kernels defaults layered on top of the shared CARTS pipeline.
################################################################################

TEMPLATE_DIR := $(abspath $(dir $(lastword $(MAKEFILE_LIST))))
SIMPLE_KERNELS_ROOT := $(abspath $(TEMPLATE_DIR)/..)
CARTS_BENCH_ROOT := $(abspath $(SIMPLE_KERNELS_ROOT)/..)
...
# Size configurations for simple kernels
