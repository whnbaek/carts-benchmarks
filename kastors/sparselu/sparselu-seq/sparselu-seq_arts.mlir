module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:o-i64:64-i128:128-n32:64-S128", llvm.target_triple = "arm64-apple-macosx16.0.0", "polygeist.target-cpu" = "apple-m1", "polygeist.target-features" = "+aes,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz"} {
  func.func @sparselu_seq_call(%arg0: memref<?xmemref<?xf32>>, %arg1: i32, %arg2: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg3 = %c0 to %0 step %c1 {
      ...
      %5 = memref.load %arg0[%4] : memref<?xmemref<?xf32>>
      func.call @lu0(%5, %arg2) : (memref<?xf32>, i32) -> ()
      %6 = arith.addi %1, %c1_i32 : i32
      %7 = arith.index_cast %6 : i32 to index
      scf.for %arg4 = %7 to %0 step %c1 {
        %8 = arith.index_cast %arg4 : index to i32
        %9 = arith.addi %2, %8 : i32
        %10 = arith.index_cast %9 : i32 to index
        %11 = memref.load %arg0[%10] : memref<?xmemref<?xf32>>
        %12 = llvm.mlir.zero : !llvm.ptr
        %13 = polygeist.memref2pointer %11 : memref<?xf32> to !llvm.ptr
        %14 = llvm.icmp "ne" %13, %12 : !llvm.ptr
        scf.if %14 {
          %15 = memref.load %arg0[%4] : memref<?xmemref<?xf32>>
          %16 = memref.load %arg0[%10] : memref<?xmemref<?xf32>>
          func.call @fwd(%15, %16, %arg2) : (memref<?xf32>, memref<?xf32>, i32) -> ()
        }
      }
      scf.for %arg4 = %7 to %0 step %c1 {
        %8 = arith.index_cast %arg4 : index to i32
        %9 = arith.muli %8, %arg1 : i32
        %10 = arith.addi %9, %1 : i32
        %11 = arith.index_cast %10 : i32 to index
        %12 = memref.load %arg0[%11] : memref<?xmemref<?xf32>>
        %13 = llvm.mlir.zero : !llvm.ptr
        %14 = polygeist.memref2pointer %12 : memref<?xf32> to !llvm.ptr
        %15 = llvm.icmp "ne" %14, %13 : !llvm.ptr
        scf.if %15 {
          %16 = memref.load %arg0[%4] : memref<?xmemref<?xf32>>
          %17 = memref.load %arg0[%11] : memref<?xmemref<?xf32>>
