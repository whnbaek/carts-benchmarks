    ...
    scf.if %6 {
      ...
      scf.for %arg8 = %c0 to %7 step %c1 {
        ...
        scf.for %arg9 = %c0 to %7 step %c1 {
          %52 = arith.index_cast %arg9 : index to i32
          %53 = arith.muli %51, %0 : i32
          %54 = arith.addi %53, %52 : i32
          %55 = arith.muli %arg5, %51 : i32
          %56 = arith.addi %55, %52 : i32
          %57 = arith.index_cast %56 : i32 to index
          %58 = arith.addi %57, %11 : index
          %59 = memref.load %arg1[%58] : memref<?xf64>
          %60 = arith.addi %57, %18 : index
          %61 = memref.load %arg1[%60] : memref<?xf64>
          %62 = arith.addf %59, %61 : f64
          %63 = llvm.getelementptr %27[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          llvm.store %62, %63 : f64, !llvm.ptr
          %64 = llvm.load %63 : !llvm.ptr -> f64
          %65 = memref.load %arg1[%57] : memref<?xf64>
          %66 = arith.subf %64, %65 : f64
          %67 = llvm.getelementptr %31[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          llvm.store %66, %67 : f64, !llvm.ptr
          %68 = arith.muli %51, %arg5 : i32
          %69 = arith.addi %68, %52 : i32
          %70 = arith.index_cast %69 : i32 to index
          %71 = arith.addi %70, %7 : index
          %72 = memref.load %arg1[%71] : memref<?xf64>
          %73 = arith.muli %0, %51 : i32
          %74 = arith.addi %73, %52 : i32
          %75 = llvm.getelementptr %31[%74] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          %76 = llvm.load %75 : !llvm.ptr -> f64
          %77 = arith.subf %72, %76 : f64
          %78 = llvm.getelementptr %35[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          llvm.store %77, %78 : f64, !llvm.ptr
          %79 = arith.muli %51, %arg6 : i32
          %80 = arith.addi %79, %52 : i32
          ...
          %86 = llvm.getelementptr %37[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          ...
          %91 = llvm.getelementptr %39[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          ...
          %96 = llvm.getelementptr %43[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          llvm.store %95, %96 : f64, !llvm.ptr
          %97 = memref.load %arg1[%57] : memref<?xf64>
          %98 = memref.load %arg1[%58] : memref<?xf64>
          %99 = arith.subf %97, %98 : f64
          %100 = llvm.getelementptr %33[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          ...
          %104 = llvm.getelementptr %41[%54] : (!llvm.ptr, i32) -> !llvm.ptr, f64
      ...
      scf.for %arg8 = %c0 to %7 step %c1 {
        ...
        scf.for %arg9 = %c0 to %7 step %c1 {
          %52 = arith.index_cast %arg9 : index to i32
          %53 = arith.muli %arg4, %51 : i32
          %54 = arith.addi %53, %52 : i32
          %55 = arith.index_cast %54 : i32 to index
          %56 = arith.muli %51, %0 : i32
          %57 = arith.addi %56, %52 : i32
          %58 = llvm.getelementptr %45[%57] : (!llvm.ptr, i32) -> !llvm.ptr, f64
          %59 = llvm.load %58 : !llvm.ptr -> f64
          %60 = memref.load %arg0[%55] : memref<?xf64>
          %61 = arith.addf %60, %59 : f64
          memref.store %61, %arg0[%55] : memref<?xf64>
