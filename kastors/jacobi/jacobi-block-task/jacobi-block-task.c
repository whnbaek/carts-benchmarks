...
#pragma omp parallel shared(u_, unew_, f_, max_blocks_x, max_blocks_y, nx, ny, \
                                dx, dy, itold, itnew, block_size)              \
...
#pragma omp task shared(u_, unew_, nx, ny, block_size)                         \
    firstprivate(block_x, block_y)
...
#pragma omp task default(none)                                                 \
    shared(u_, unew_, f_, dx, dy, nx, ny, block_size)                          \
    firstprivate(block_x, block_y)
