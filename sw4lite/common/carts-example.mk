...
SW4LITE_TEMPLATE_DIR := $(abspath $(dir $(lastword $(MAKEFILE_LIST))))
SW4LITE_ROOT := $(abspath $(SW4LITE_TEMPLATE_DIR)/..)
CARTS_BENCH_ROOT := $(abspath $(SW4LITE_ROOT)/..)
...
small:
	...
	$(MAKE) all CFLAGS="-DNX=10 -DNY=10 -DNZ=10 $(EXTRA_CFLAGS)"

medium:
	@echo "[$(EXAMPLE_NAME)] Building with MEDIUM size (21x21x22 ≈ 10000 elements)"
	$(MAKE) all CFLAGS="-DNX=21 -DNY=21 -DNZ=22 $(EXTRA_CFLAGS)"

large:
	@echo "[$(EXAMPLE_NAME)] Building with LARGE size (46x46x47 ≈ 100000 elements)"
	$(MAKE) all CFLAGS="-DNX=46 -DNY=46 -DNZ=47 $(EXTRA_CFLAGS)"
